      ...
      <div className="auth-container-2">
        ...
        <form onSubmit={handleSubmit}>
          ...
          { 
            isSignup && (
              <label htmlFor="check">
                <input type="checkbox" id='check' style={{marginBottom:"38px"}}/>
                <p style={{fontSize:"13px",marginLeft:'8px'}}>opt-in to receive occasional <br />product updates, user research invitations, <br />company announcements, and digests</p>
              </label>
            )
          }
